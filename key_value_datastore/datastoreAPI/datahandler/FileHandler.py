...
from .Pointer import Pointer, Pointer_from_string, Pointer_from_bytes
from .Key import Key, Key_from_bytes, Key_from_string
from .Value import Value, Value_from_encoded_string, Value_from_encoded_bytes
...
class DatastoreFileHandler:
    ...
    def write_KeyValue(self, key_str: str, value_str: dict, time_to_live: int=None) -> bool:
